...
import { ShieldCheck, ChevronRight, ChevronLeft, Save, AlertTriangle, ArrowLeft } from 'lucide-react';
...
export default function NewAssessmentWizard() {
  ...
  const canProceed = step === 0 ? isIdentityValid : true;
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-10 flex flex-col items-center">
          <div className="w-full max-w-3xl flex-1 flex flex-col">
            ...
            {step === 4 && (
              <div className="flex-1">
                <div className="mb-6">
                  <h2 className="text-2xl font-bold text-slate-800">D. Barınma ve Kırılganlık</h2>
