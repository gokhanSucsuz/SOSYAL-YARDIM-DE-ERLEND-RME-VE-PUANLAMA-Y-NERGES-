...
export default function GatePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#0c1e3a] p-4 selection:bg-primary-600 selection:text-white">
      <div className="bg-[#132d54] p-8 rounded-3xl shadow-2xl shadow-black/50 border border-primary-900/50 w-full max-w-md relative overflow-hidden text-slate-100">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primary-500 via-amber-400 to-primary-600"></div>
        
        <div className="flex justify-center mb-6">
          <ShieldAlert size={64} className="text-primary-400" />
        </div>
        ...
        <GoogleOAuthProvider clientId={clientId}>
          <div className="flex flex-col items-center justify-center bg-[#0c1e3a]/50 p-6 rounded-2xl border border-primary-800/40 min-h-[120px]">
            {loading ? (
