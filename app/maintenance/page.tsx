...
export default function Maintenance() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-100 dark:bg-slate-800/50 relative p-4 py-12 selection:bg-red-600 selection:text-white">
      <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-2xl shadow-slate-950/10 border border-slate-200 dark:border-slate-700 w-full max-w-md relative overflow-hidden text-slate-900 dark:text-slate-100 text-center">
        ...
        <div className="flex justify-center mb-6 mt-2">
          <div className="relative group">
            ...
            <LogoImage className="relative w-24 h-24 rounded-2xl shadow-xl border-2 border-slate-200 dark:border-slate-700 object-cover" />
          </div>
        </div>

        <h1 className="text-2xl sm:text-3xl font-black mb-3 text-slate-900 dark:text-slate-100 tracking-tight flex items-center justify-center gap-2">
