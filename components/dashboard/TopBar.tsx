...
export function TopBar({
  ...
  return (
    <div className="space-y-6 w-full">
      ...
      {user.role === 'manager' && (
        <div className="bg-white dark:bg-slate-800 p-2 rounded-xl flex flex-wrap sm:flex-nowrap items-center gap-2 border border-slate-200 dark:border-slate-700 shadow-sm">
          ...
          <Link
            href="/statistics"
            className="flex-1 flex items-center justify-center gap-2.5 px-4 py-3 rounded-lg font-bold text-xs sm:text-sm transition-all touch-manipulation cursor-pointer text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:text-slate-200 bg-transparent hover:bg-slate-50 dark:bg-slate-900"
          >
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
          ...
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 bg-slate-100 dark:bg-slate-800/50 hover:bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 border border-slate-300 dark:border-slate-600 px-4 py-2.5 rounded-lg font-bold text-sm transition-colors shadow-sm touch-manipulation"
